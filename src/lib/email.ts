...
const REPLY_TO = import.meta.env.EMAIL_REPLY_TO ?? process.env.EMAIL_REPLY_TO ?? "hello@coreandflowpilates.com";
...
export async function sendBookingConfirmation(args: {
  ...
  return sendEmail({
    to: args.to,
    subject: `Booking confirmed: ${args.className} on ${args.sessionDate}`,
